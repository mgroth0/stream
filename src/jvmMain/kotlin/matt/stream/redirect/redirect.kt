...
/*TODO: If I redirect std out and std in, I should detect if normal std out and std in is ever written to (like from native libs, it happens.) and warn myself. So important!!*/
